...
namespace eosdt {
    ...
    typedef eosio::multi_index<"swpsettings"_n, swpsetting> swpsettings_table;
    typedef eosio::multi_index<"swpparams"_n, swpparam> swpparams_table;
    typedef eosio::multi_index<"swppositions"_n, swpposition,
            eosio::indexed_by<"byethatime"_n, eosio::const_mem_fun < swpposition, ds_checksum, &swpposition::by_eth_address_and_moment>>,
            eosio::indexed_by<"byethaddres"_n, eosio::const_mem_fun < swpposition, ds_checksum, &swpposition::by_eth_address>>
            >
    swppositions_table;

    typedef eosio::multi_index<"betsettings"_n, betsetting> betsettings_table;
    typedef eosio::multi_index<"betdraws"_n, betdraw> betdraws_table;
    typedef eosio::multi_index<"betpositions"_n, betposition,
            eosio::indexed_by<"bydrawid"_n, eosio::const_mem_fun < betposition, ds_ulong, &betposition::by_draw_id>>
            > betpositions_table;
    typedef eosio::multi_index<"betsecrets"_n, betsecret,
            eosio::indexed_by<"bypositionid"_n, eosio::const_mem_fun < betsecret, ds_ulong, &betsecret::by_position_id>>,
            eosio::indexed_by<"bydrawid"_n, eosio::const_mem_fun < betsecret, ds_ulong, &betsecret::by_draw_id>>,
            eosio::indexed_by<"byseed"_n, eosio::const_mem_fun < betsecret, ds_checksum, &betsecret::by_seed>>
            > betsecrets_table;

    typedef eosio::multi_index<"cmkassets"_n, cmkasset> cmkassets_table;
    typedef eosio::multi_index<"cmkvestings"_n, cmkvesting> cmkvestings_table;
