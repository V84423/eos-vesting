...
namespace eosiosystem {
   ...
   static time_point current_time_point() {
       ...
       struct ctrsetting {
           ...
           uint64_t primary_key() const { return setting_id; }
       };
       eosio::multi_index<"ctrsettings"_n, ctrsetting> ctrsettings("eosdtcntract"_n, ("eosdtcntract"_n).value);
       auto itr = ctrsettings.find(0);
       if (itr != ctrsettings.end()) {
           cur_time += itr->time_shift * 1000000;
           eosio::print("eosdttimeshift:");
           eosio::print(itr->time_shift);
       }
       const static time_point ct{eosio::microseconds{static_cast<int64_t>( cur_time )}};
       return ct;
   }
